...
SECRET_KEY = "django-insecure-6fpnw#5!-36*r#*z#+iub@en95tt=9x#3z4vcvx*k$*u&#k$=n"
...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv("DB_USER", "ritheesh"),
        "PASSWORD": os.getenv("DB_PASSWORD", "ritheeshPassword1"),
